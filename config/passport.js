...
module.exports = function(passport) {
  ...
  function(req, accessToken, refreshToken, profile, done){
    ...
    callbackURL: "http://ec2-52-77-223-15.ap-southeast-1.compute.amazonaws.com:3000/auth/twitter/callback",
    passReqToCallback: true
  },
    function(req, token, tokenSecret, profile, done){
      ...
      callbackURL: "http://ec2-52-77-223-15.ap-southeast-1.compute.amazonaws.com:3000/auth/instagram/callback",
      passReqToCallback: true
      },
      function(req, accessToken, refreshToken, profile, done) {
        ...
        callbackURL: "http://ec2-52-77-223-15.ap-southeast-1.compute.amazonaws.com:3000/auth/google/callback",
        passReqToCallback: true
        },
        function(req, accessToken, refreshToken, profile, done) {
